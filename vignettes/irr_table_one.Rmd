...
vignette: >
  %\VignetteIndexEntry{irr_table_one}
...
# Welcome to the Irish Renal Registry R Package
Let's start exploring. The first thing to do is call the irishrenalregistry R library.

```{r setup, warning=FALSE, message=FALSE}
library(irishrenalregistry)
```

# Create your first Irish Renal Registry Analysis
